...
from .views import CreateMetadataView, DataCrudView, GetDataView, CollectionView, AddCollection, AddDatabase, serviceInfo
...
urlpatterns = [
    ...
    path('create-metadata/', CreateMetadataView.as_view(), name='create-metadata'),
