...
class DataCrudView(APIView):
    def get(self, request, *args, **kwargs):
        try:
            serializer = InputGetSerializer(data=request.GET)
            ...
            payment = request.GET.get('payment', True)
...
class AddCollection(APIView):
    def post(self, request, *args, **kwargs):
        try:
            ...
            collections = collection.find_one({"database_name": database})
